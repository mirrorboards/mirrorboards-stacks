module actaboards-indexer-proc-postgres-indexer
...
require (
	...
	github.com/pulumi/pulumi-cloudflare/sdk/v6 v6.4.1 // indirect
	github.com/pulumi/pulumi-digitalocean/sdk/v4 v4.56.0 // indirect
